...
var acym_editorWysidContextModal = {
  ...
  setTextContextOptions: function setTextContextOptions() {
    jQuery('.acym__wysid__tinymce--text').off('click').on('click', function (event) {
      ...
      var $tdParent = $text.closest('.acym__wysid__column__element__td');
      jQuery(window).off('mousedown').on('mousedown', function (event) {
  ...
  setPoweredByContextModal: function setPoweredByContextModal() {
  ...
  openDContentModal: function openDContentModal(plugin, shortcode) {
    ...
    jQuery.ajax({
      ...
      success: function success(data) {
        ...
        acym_editorWysidDynamic.setPluginPagination(); // Reload foundation for tabs in plugins popup
...
var acym_editorWysidFontStyle = {
  allTags: ['p', 'a', 'span.acym_link', 'li', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6'],
  ...
  setSettingsElementStyle: function setSettingsElementStyle(element, property, value) {
    ...
    if (!override && !acym_helper.empty(acym_helperEditorWysid.mailsSettings[element].overridden) && !acym_helper.empty(acym_helperEditorWysid.mailsSettings[element].overridden[property])) {
      return;
    }
  ...
  setSettingsControlsWYSID: function setSettingsControlsWYSID() {
    ...
    jQuery('#acym__wysid__right__toolbar__settings__font-family').off('select2:select').on('change select2:select', function (event) {
      acym_editorWysidFontStyle.setSettingsElementStyle(jQuery('#acym__wysid__right__toolbar__settings__font--select').val(), 'font-family', jQuery(this).val(), event.type !== 'change');
    });
...
var acym_editorWysidFormAction = {
  ...
  setEditButtonWYSID: function setEditButtonWYSID() {
    jQuery('#acym__wysid__edit__button').off('click').on('click', function () {
      ...
      acym_helperEditorWysid.setColumnRefreshUiWYSID();
      acym_helperEditorWysid.setInitFunctionsOnEdtionStart(); // When the edition starts, we reload the editor
...
function showThumb(data) {
  ...
  var thumbWithLink = '<a href="https://vimeo.com/' + data[0].id + '">';
...
var acym_editorWysidTinymce = {
  addTinyMceWYSID: function addTinyMceWYSID() {
    ...
    tinymce.init({
      ...
      toolbar: ['undo redo formatselect fontselect fontsizeselect | alignmentsplit | listsplit lineheightselect | table', 'bold italic underline strikethrough removeformat | forecolor backcolor | link unlink | code'],
      link_class_list: [{
        title: 'None',
        value: ''
      }, {
