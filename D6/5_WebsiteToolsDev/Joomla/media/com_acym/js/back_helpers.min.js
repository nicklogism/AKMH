...
var acym_helperFilter = {
    ...
    jQuery('[acym-automation-reload]').each(function () {
      jQuery(this).on('change', function () {
        ...
        setTimeout(function () {
          ...
          var decodedParams = JSON.parse(params);
  ...
  setToggle: function setToggle($toggle) {
    ...
    var $blockToToggle = $toggle.closest(".".concat(parentClass)).find(".".concat(paramsToggle["class"]));
...
var acym_helperSegment = {
  ...
  reloadCounters: function reloadCounters(element) {
    ...
    this.ajaxCalls[and] = jQuery.post(ajaxUrl, ajaxData).done(function (result) {
